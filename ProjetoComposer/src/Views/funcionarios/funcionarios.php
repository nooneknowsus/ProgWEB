...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Funcionarios</h1>
        <a href="/funcionarios/inserir" class="btn btn-primary">Novo Funcionario</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['cpf'] ?></td>
                            <td>
                                <a href="/funcionarios/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/funcionarios/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
