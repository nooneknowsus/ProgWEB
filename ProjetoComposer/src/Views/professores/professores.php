...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Professores</h1>
        <a href="/professores/inserir" class="btn btn-primary">Novo Professor</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['graduacao'] ?></td>
                            <td>
                                <a href="/professores/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/professores/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
