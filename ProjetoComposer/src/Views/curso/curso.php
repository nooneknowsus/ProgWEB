...
<html lang="en">
  ...
  <body>
    <main class="container">
        <h1>Alunos</h1>
        <a href="/alunos/inserir" class="btn btn-primary">Novo Alunos</a>
        <p><?= $mensagem ?></p>
                ...
                <?php
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= $c['ra'] ?></td>
                            <td>
                                <a href="/alunos/alterar/id/<?= $c["id"]?>" class="btn btn-warning">
                                    Alterar
                                </a>
                                <a href="/alunos/excluir/id/<?= $c["id"]?>" class="btn btn-danger">
                                    Excluir
                                </a>
                            </td>
                        </tr>
