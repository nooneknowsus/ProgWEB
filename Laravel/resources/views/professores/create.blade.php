        ...
        <form action="{{ route('professores.store') }}" method="POST">
            ...
            <div class="row mb-3 mt-3">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" maxlength="60" name="nome" placeholder="Nome">

                    <label for="curso" class="form-label mt-2">Graduação</label>
                    <input type="text" class="form-control" maxlength="60" name="curso" placeholder="Curso">
